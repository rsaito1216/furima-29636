...
# レディース
lady = Categorytest.create(name: "レディース")
...
# メンズ
men = Categorytest.create(name: "メンズ")
...
# ベビー・キッズ
baby_kids = Categorytest.create(name: "ベビー・キッズ")
...
# インテリア・住まい・小物
interior_residence_accessory = Categorytest.create(name: "インテリア・住まい・小物")
...
# 本・音楽・ゲーム
book_music_game = Categorytest.create(name: "本・音楽・ゲーム")
...
# おもちゃ・ホビー・グッズ
toy_hobby_goods = Categorytest.create(name: "おもちゃ・ホビー・グッズ")
...
# コスメ・香水・美容
cosme_perfume_beauty = Categorytest.create(name: "コスメ・香水・美容")
...
# 家電・スマホ・カメラ
appliance_smartphone_camera = Categorytest.create(name: "家電・スマホ・カメラ")
...
# スポーツ・レジャー
sport_leisure = Categorytest.create(name: "スポーツ・レジャー")
...
# ハンドメイド
handmade = Categorytest.create(name: "ハンドメイド")
...
# チケット
ticket = Categorytest.create(name: "チケット")
...
# 自動車・オートバイ
car_motorcycle = Categorytest.create(name: "自動車・オートバイ")
...
# その他
others = Categorytest.create(name: "その他")
