...
ActiveRecord::Schema.define(version: 2020_11_27_055725) do
  ...
  create_table "categorytests", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.string "ancestry"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["ancestry"], name: "index_categorytests_on_ancestry"
  end
  ...
  create_table "orders", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_transaction_id"], name: "index_orders_on_item_transaction_id"
  end
  ...
  add_foreign_key "orders", "item_transactions"
